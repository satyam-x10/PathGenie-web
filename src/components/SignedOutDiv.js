...
const SignedOutDiv = () => {
  return (
    <div
      className="flex flex-col w-full items-center justify-center min-h-[100dvh] p-4 md:p-6 
    ...
    >
      <div className="max-w-md mx-auto space-y-6 md:space-y-8 animate-fade-in">
        ...
        {/* Description text */}
        <p
          className="text-base md:text-lg text-gray-300 px-4 md:px-6 
              leading-relaxed max-w-sm mx-auto"
        >
          To access your Path Genie, please provide your identity. Your journey
          begins with signing in!
        </p>

        {/* Sign In Button with animation */}
        <SignInButton mode="modal">
          <button
            className="group relative px-6 py-3 md:px-8 md:py-4 
