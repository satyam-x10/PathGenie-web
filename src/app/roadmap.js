...
const TaskComponent = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg relative">
      {/* Connector Dots */}
      <span className="absolute left-0 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-gray-500 rounded-full"></span>
      <span className="absolute right-0 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-gray-500 rounded-full"></span>
      <span className="absolute left-1/2 top-0 transform -translate-x-1/2 w-2 h-2 bg-gray-500 rounded-full"></span>
      <span className="absolute left-1/2 bottom-0 transform -translate-x-1/2 w-2 h-2 bg-gray-500 rounded-full"></span>
