...
export async function POST(req) {
  try {
    ...
    return new Response(
      JSON.stringify({ message: "Resource created", newResource }),
      {
        status: 201,
        headers: { "Content-Type": "application/json" },
      },
...
export async function PUT(req) {
  try {
    ...
    if (!id) {
      return new Response(
        JSON.stringify({ message: "Resource ID is required" }),
        {
          status: 400,
          headers: { "Content-Type": "application/json" },
        },
    ...
    if (!updatedResource) {
      return new Response(
        JSON.stringify({ message: "Resource not found or update failed" }),
        {
          status: 404,
          headers: { "Content-Type": "application/json" },
        },
    ...
    return new Response(
      JSON.stringify({ message: "Resource updated", updatedResource }),
      {
        status: 200,
        headers: { "Content-Type": "application/json" },
      },
...
export async function DELETE(req) {
  try {
    ...
    if (!id) {
      return new Response(
        JSON.stringify({ message: "Resource ID query parameter required" }),
        {
          status: 400,
          headers: { "Content-Type": "application/json" },
        },
    ...
    if (!deletedResource) {
      return new Response(
        JSON.stringify({ message: "Resource not found or delete failed" }),
        {
          status: 404,
          headers: { "Content-Type": "application/json" },
        },
    ...
    return new Response(
      JSON.stringify({ message: "Resource deleted", deletedResource }),
      {
        status: 200,
        headers: { "Content-Type": "application/json" },
      },
